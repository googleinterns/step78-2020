...
public class Recitation {
  ...
  public Recitation(List<TimeRange> meetingTimes) {
    ...
    for (int i = 0; i < meetingTimes.size() - 1; i++) {
      if (meetingTimes.get(i).overlaps(meetingTimes.get(i + 1))) {
        throw new IllegalArgumentException("Recitation times can't overlap!");
      }
    }
  }
  ...
  public boolean equals(Object other) {
    ...
    return otherSection.meetingTimes.equals(this.meetingTimes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meetingTimes);
  }
